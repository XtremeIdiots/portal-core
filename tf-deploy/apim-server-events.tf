...
resource "azurerm_api_management_api_policy" "server_events_api_policy" {
  ...
  xml_content = replace(file("./policies/ServerEventsPolicy.xml"), "__CODE__", data.azurerm_function_app_host_keys.events_function_app_host_key.default_function_key)
}
