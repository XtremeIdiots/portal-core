...
resource "azurerm_api_management_api_policy" "player_ingest_api_policy" {
  ...
  xml_content = replace(file("./policies/PlayerIngestPolicy.xml"), "__CODE__", data.azurerm_function_app_host_keys.ingest_function_app_host_key.default_function_key)
}
